 ...
 * generated in the com.denovo.p8583server.memweb package. 
...
public class ObjectFactory {
    ...
    private final static QName _Execute_QNAME = new QName("http://service.ws.crm.ce.com/", "execute");
    private final static QName _ExecuteResponse_QNAME = new QName("http://service.ws.crm.ce.com/", "executeResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.denovo.p8583server.memweb
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.crm.ce.com/", name = "execute")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.crm.ce.com/", name = "executeResponse")
